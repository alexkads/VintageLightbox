...
uma_linha() { "$@" 2>/dev/null | head -1 || true; }
retrato() {
  ...
  if command -v gnome-shell >/dev/null 2>&1; then
    ...
    echo "extensão AppIndicator: $(gnome-extensions info appindicatorsupport@rgcjonas.gmail.com 2>/dev/null | grep -i -E 'enabled|state' | tr '\n' ' ' || true)"
