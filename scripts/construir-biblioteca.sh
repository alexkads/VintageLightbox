...
VERSAO="$VERSAO-$(shasum -a 256 < "$PUBLICO/biblioteca_web.js" | cut -c1-8)$(shasum -a 256 < "$PUBLICO/biblioteca_web_bg.wasm" | cut -c1-8)"
...
// É o commit e o hash do conteúdo da biblioteca que está em public/biblioteca/, e vai na URL dos dois
