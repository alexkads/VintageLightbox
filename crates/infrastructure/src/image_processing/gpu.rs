...
impl From<&PhotoEdits> for GpuEditParams {
    fn from(edits: &PhotoEdits) -> Self {
        Self {
            ...
            tone_curve_shadows: edits.tone_curve_shadows,
            tone_curve_darks: edits.tone_curve_darks,
            tone_curve_lights: edits.tone_curve_lights,
            tone_curve_highlights: edits.tone_curve_highlights,
            hsl_red_sat: edits.hsl_red_sat,
            hsl_orange_sat: edits.hsl_orange_sat,
            hsl_yellow_sat: edits.hsl_yellow_sat,
            hsl_green_sat: edits.hsl_green_sat,
            hsl_aqua_sat: edits.hsl_aqua_sat,
            hsl_blue_sat: edits.hsl_blue_sat,
            hsl_purple_sat: edits.hsl_purple_sat,
            hsl_magenta_sat: edits.hsl_magenta_sat,
            hsl_red_hue: edits.hsl_red_hue,
            hsl_orange_hue: edits.hsl_orange_hue,
            hsl_yellow_hue: edits.hsl_yellow_hue,
            hsl_green_hue: edits.hsl_green_hue,
            hsl_aqua_hue: edits.hsl_aqua_hue,
            hsl_blue_hue: edits.hsl_blue_hue,
            hsl_purple_hue: edits.hsl_purple_hue,
            hsl_magenta_hue: edits.hsl_magenta_hue,
            hsl_red_lum: edits.hsl_red_lum,
            hsl_orange_lum: edits.hsl_orange_lum,
            hsl_yellow_lum: edits.hsl_yellow_lum,
            hsl_green_lum: edits.hsl_green_lum,
            hsl_aqua_lum: edits.hsl_aqua_lum,
            hsl_blue_lum: edits.hsl_blue_lum,
            hsl_purple_lum: edits.hsl_purple_lum,
            hsl_magenta_lum: edits.hsl_magenta_lum,
            lens_distortion: edits.lens_distortion,
            lens_vignette_amount: edits.lens_vignette_amount,
            lens_vignette_midpoint: edits.lens_vignette_midpoint,
            nr_luminance: edits.nr_luminance,
            nr_color: edits.nr_color,
            sharpen_amount: edits.sharpen_amount,
            sharpen_radius: edits.sharpen_radius,
        }
    }
}
