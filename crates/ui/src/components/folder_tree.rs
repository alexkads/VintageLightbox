...
impl<'a> FolderTree<'a> {
    pub fn new(selected_path: Option<&'a Path>, expanded_paths: &'a mut HashSet<String>) -> Self {
        Self {
            selected_path,
            expanded_paths,
        }
...
mod tests {
    ...
    fn test_build_tree_single_year() {
        let _photos = vec![create_mock_photo("/Volumes/SSD/Photos/2023/Trip/1.jpg")];
