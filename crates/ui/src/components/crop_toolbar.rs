...
impl CropToolbar {
    pub fn show(
        ...
        ui.horizontal(|ui| {
            ...
            ComboBox::from_id_salt("crop_aspect_ratio")
                ...
                .show_ui(ui, |ui| {
                    ui.selectable_value(
                        ...
                        AspectRatio::Original.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::Free,
                        AspectRatio::Free.to_string(),
                    );
                    ui.separator();
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::Square,
                        AspectRatio::Square.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::TwoThree,
                        AspectRatio::TwoThree.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::ThreeTwo,
                        AspectRatio::ThreeTwo.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::FourThree,
                        AspectRatio::FourThree.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::ThreeFour,
                        AspectRatio::ThreeFour.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::FourFive,
                        AspectRatio::FourFive.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::FiveFour,
                        AspectRatio::FiveFour.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::FiveSeven,
                        AspectRatio::FiveSeven.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::SevenFive,
                        AspectRatio::SevenFive.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::SixteenNine,
                        AspectRatio::SixteenNine.to_string(),
                    );
                    ui.selectable_value(
                        selected_ratio,
                        AspectRatio::NineSixteen,
                        AspectRatio::NineSixteen.to_string(),
                    );
                });
            ...
            *on_rotate = ui
                .button(format!("{} Rotate", icons::ARROWS_CLOCKWISE))
