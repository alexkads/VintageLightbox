...
impl DevelopView {
            ...
            .show_inside(ui, |ui| {
                ...
                if let Some(photo_id) = pending_selection {
                    ...
                    let needs_save = state.pending_auto_save
                        || (state.crop_mode_active && state.crop_settings.is_some());
                    ...
                    if needs_save {
                        if let Some(vm) = state.get_current_photo() {
                            ...
                            if let Some(photo_vm) =
                                state.photos.iter_mut().find(|p| p.id == id_for_update)
                            {
                    ...
                    if apply {
                        ...
                        if let Some(id) = state.develop_selected_photo_id.clone() {
                            ...
                            if let Some(photo_vm) = state.photos.iter_mut().find(|p| p.id == id) {
                                ...
                                photo_vm.edit_crop_width =
                                    active_crop.as_ref().map(|c| c.crop_width());
                                photo_vm.edit_crop_height =
                                    active_crop.as_ref().map(|c| c.crop_height());
                                photo_vm.edit_crop_rotation =
                                    active_crop.as_ref().map(|c| c.rotation_90());
                                photo_vm.edit_crop_angle = active_crop.as_ref().map(|c| c.angle());
                                photo_vm.edit_crop_flip_h =
                                    active_crop.as_ref().map(|c| c.flip_horizontal());
                                photo_vm.edit_crop_flip_v =
                                    active_crop.as_ref().map(|c| c.flip_vertical());
                                photo_vm.edit_exposure = Some(exposure);
                                photo_vm.edit_contrast = Some(contrast);
    ...
    fn show_left_sidebar(&mut self, ui: &mut Ui, state: &mut AppState) {
        ...
        let system_presets: Vec<_> = state
            .presets
            .iter()
            .filter(|p| p.is_system)
            .cloned()
            .collect();
        let user_presets: Vec<_> = state
            .presets
            .iter()
            .filter(|p| !p.is_system)
            .cloned()
    ...
    fn show_right_sidebar(
        ...
        use crate::components::{
            histogram_plot::HistogramPlot, rating_widget::RatingWidget,
            slider_control::SliderControl, tone_curve::ToneCurveEditor,
        };
        use crate::design_system::widgets;
        ...
        // Exposure slider
        if SliderControl::show(ui, "Exposure", &mut state.active_exposure, -2.0..=2.0, 0.1) {
        ...
        // Contrast slider
        if SliderControl::show(ui, "Contrast", &mut state.active_contrast, 0.5..=1.5, 0.05) {
            any_slider_changed = true;
        }
        ...
        // Tint slider
        if SliderControl::show(ui, "Tint", &mut state.active_tint, -10.0..=10.0, 0.5) {
            any_slider_changed = true;
        }
        ...
        // Whites slider
        if SliderControl::show(ui, "Whites", &mut state.active_whites, -100.0..=100.0, 5.0) {
            any_slider_changed = true;
        }
        ...
        // Blacks slider
        if SliderControl::show(ui, "Blacks", &mut state.active_blacks, -100.0..=100.0, 5.0) {
            any_slider_changed = true;
        }
        ...
        // Clarity slider
        if SliderControl::show(ui, "Clarity", &mut state.active_clarity, -1.0..=1.0, 0.05) {
            any_slider_changed = true;
        }
        ...
        // Vibrance slider
        if SliderControl::show(ui, "Vibrance", &mut state.active_vibrance, -1.0..=1.0, 0.05) {
            any_slider_changed = true;
        }
        ...
        if SliderControl::show(
            ui,
            "Orange Hue",
            &mut state.active_hsl_orange_hue,
            -180.0..=180.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Yellow Hue",
            &mut state.active_hsl_yellow_hue,
            -180.0..=180.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Green Hue",
            &mut state.active_hsl_green_hue,
            -180.0..=180.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Purple Hue",
            &mut state.active_hsl_purple_hue,
            -180.0..=180.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Magenta Hue",
            &mut state.active_hsl_magenta_hue,
            -180.0..=180.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Orange Lum",
            &mut state.active_hsl_orange_lum,
            -100.0..=100.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Yellow Lum",
            &mut state.active_hsl_yellow_lum,
            -100.0..=100.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Green Lum",
            &mut state.active_hsl_green_lum,
            -100.0..=100.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Purple Lum",
            &mut state.active_hsl_purple_lum,
            -100.0..=100.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Magenta Lum",
            &mut state.active_hsl_magenta_lum,
            -100.0..=100.0,
            5.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Distortion",
            &mut state.active_lens_distortion,
            -100.0..=100.0,
            1.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Vignette Amount",
            &mut state.active_lens_vignette_amount,
            -100.0..=100.0,
            1.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(
            ui,
            "Vignette Midpoint",
            &mut state.active_lens_vignette_midpoint,
            0.0..=100.0,
            1.0,
        ) {
            any_slider_changed = true;
        ...
        if SliderControl::show(ui, "Color NR", &mut state.active_nr_color, 0.0..=100.0, 1.0) {
            any_slider_changed = true;
        }
        ...
        if ui
            .button(egui::RichText::new("Delete Photo").color(egui::Color32::from_rgb(200, 60, 60)))
            .clicked()
        {
