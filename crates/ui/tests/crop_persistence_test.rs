...
use domain::value_objects::{CropSettings, FilePath};
use std::sync::Arc;
use ui::state::{AppState, CurrentView};
use use_cases::SavePhotoEditsUseCase; // Reduced unused // Correct import
...
async fn test_crop_persistence_flow() {
    ...
    let crop_settings = CropSettings::new(
        0.1, 0.1, 0.5, 0.5, 1, 15.0, // Rotated 90 + 15 deg
        true, false,
    );
    ...
    editor_controller
        .save_edits(
            vm.id.clone(),
            vm.edit_exposure.unwrap_or(0.0),
            vm.edit_contrast.unwrap_or(0.0),
            vm.edit_temperature.unwrap_or(0.0),
            vm.edit_tint.unwrap_or(0.0),
            vm.edit_highlights.unwrap_or(0.0),
            vm.edit_shadows.unwrap_or(0.0),
            vm.edit_whites.unwrap_or(0.0),
            vm.edit_blacks.unwrap_or(0.0),
            vm.edit_clarity.unwrap_or(0.0),
            vm.edit_vibrance.unwrap_or(0.0),
            vm.edit_saturation.unwrap_or(0.0),
            vm.edit_tone_curve_shadows.unwrap_or(0.0),
            vm.edit_tone_curve_darks.unwrap_or(0.0),
            vm.edit_tone_curve_lights.unwrap_or(0.0),
            vm.edit_tone_curve_highlights.unwrap_or(0.0),
            vm.edit_hsl_red_sat.unwrap_or(0.0),
            vm.edit_hsl_orange_sat.unwrap_or(0.0),
            vm.edit_hsl_yellow_sat.unwrap_or(0.0),
            vm.edit_hsl_green_sat.unwrap_or(0.0),
            vm.edit_hsl_aqua_sat.unwrap_or(0.0),
            vm.edit_hsl_blue_sat.unwrap_or(0.0),
            vm.edit_hsl_purple_sat.unwrap_or(0.0),
            vm.edit_hsl_magenta_sat.unwrap_or(0.0),
            vm.edit_hsl_red_hue.unwrap_or(0.0),
            vm.edit_hsl_orange_hue.unwrap_or(0.0),
            vm.edit_hsl_yellow_hue.unwrap_or(0.0),
            vm.edit_hsl_green_hue.unwrap_or(0.0),
            vm.edit_hsl_aqua_hue.unwrap_or(0.0),
            vm.edit_hsl_blue_hue.unwrap_or(0.0),
            vm.edit_hsl_purple_hue.unwrap_or(0.0),
            vm.edit_hsl_magenta_hue.unwrap_or(0.0),
            vm.edit_hsl_red_lum.unwrap_or(0.0),
            vm.edit_hsl_orange_lum.unwrap_or(0.0),
            vm.edit_hsl_yellow_lum.unwrap_or(0.0),
            vm.edit_hsl_green_lum.unwrap_or(0.0),
            vm.edit_hsl_aqua_lum.unwrap_or(0.0),
            vm.edit_hsl_blue_lum.unwrap_or(0.0),
            vm.edit_hsl_purple_lum.unwrap_or(0.0),
            vm.edit_hsl_magenta_lum.unwrap_or(0.0),
            vm.edit_lens_distortion.unwrap_or(0.0),
            vm.edit_lens_vignette_amount.unwrap_or(0.0),
            vm.edit_lens_vignette_midpoint.unwrap_or(0.0),
            vm.edit_nr_luminance.unwrap_or(0.0),
            vm.edit_nr_color.unwrap_or(0.0),
            vm.edit_sharpen_amount.unwrap_or(0.0),
            vm.edit_sharpen_radius.unwrap_or(0.0),
    ...
    let loaded_vm = newly_loaded_photos
        .iter()
        .find(|p| p.id == photo_id.to_string())
        .unwrap();
...
async fn test_crop_persistence_on_photo_switch() {
    ...
    let crop_settings = CropSettings::new(0.2, 0.2, 0.6, 0.6, 0, 10.0, false, true);
