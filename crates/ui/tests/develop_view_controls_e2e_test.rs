        ...
        egui::CentralPanel::default().show(ui.ctx(), |ui| {
            ui.vertical(|ui| {
                ...
                SliderControl::show(
                    ui,
                    "Vignette Amount",
                    &mut s.active_lens_vignette_amount,
                    -100.0..=100.0,
                    1.0,
                );
                SliderControl::show(
                    ui,
                    "Vignette Midpoint",
                    &mut s.active_lens_vignette_midpoint,
                    0.0..=100.0,
                    1.0,
                );
            });
