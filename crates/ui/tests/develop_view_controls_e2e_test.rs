...
fn create_develop_view_harness() -> (Harness<'static>, Rc<RefCell<AppState>>) {
    ...
    let develop_view = Rc::new(RefCell::new(develop_view));
    ...
    let harness = Harness::new_ui(move |ui| {
        ...
        egui::CentralPanel::default().show(ui.ctx(), |ui| {
            ui.vertical(|ui| {
                ...
                SliderControl::show(ui, "Red Hue", &mut s.active_hsl_red_hue, -180.0..=180.0, 5.0);
                SliderControl::show(ui, "Orange Hue", &mut s.active_hsl_orange_hue, -180.0..=180.0, 5.0);
                SliderControl::show(ui, "Yellow Hue", &mut s.active_hsl_yellow_hue, -180.0..=180.0, 5.0);
                SliderControl::show(ui, "Green Hue", &mut s.active_hsl_green_hue, -180.0..=180.0, 5.0);
                SliderControl::show(ui, "Aqua Hue", &mut s.active_hsl_aqua_hue, -180.0..=180.0, 5.0);
                SliderControl::show(ui, "Blue Hue", &mut s.active_hsl_blue_hue, -180.0..=180.0, 5.0);
                SliderControl::show(ui, "Purple Hue", &mut s.active_hsl_purple_hue, -180.0..=180.0, 5.0);
                SliderControl::show(ui, "Magenta Hue", &mut s.active_hsl_magenta_hue, -180.0..=180.0, 5.0);
                
                // HSL Luminance Section
                widgets::section_title(ui, "HSL / Luminance");
                SliderControl::show(ui, "Red Lum", &mut s.active_hsl_red_lum, -100.0..=100.0, 5.0);
                SliderControl::show(ui, "Orange Lum", &mut s.active_hsl_orange_lum, -100.0..=100.0, 5.0);
                SliderControl::show(ui, "Yellow Lum", &mut s.active_hsl_yellow_lum, -100.0..=100.0, 5.0);
                SliderControl::show(ui, "Green Lum", &mut s.active_hsl_green_lum, -100.0..=100.0, 5.0);
                SliderControl::show(ui, "Aqua Lum", &mut s.active_hsl_aqua_lum, -100.0..=100.0, 5.0);
                SliderControl::show(ui, "Blue Lum", &mut s.active_hsl_blue_lum, -100.0..=100.0, 5.0);
                SliderControl::show(ui, "Purple Lum", &mut s.active_hsl_purple_lum, -100.0..=100.0, 5.0);
                SliderControl::show(ui, "Magenta Lum", &mut s.active_hsl_magenta_lum, -100.0..=100.0, 5.0);
                
                // Lens Corrections Section
                widgets::section_title(ui, "Lens Corrections");
                SliderControl::show(ui, "Distortion", &mut s.active_lens_distortion, -100.0..=100.0, 1.0);
                SliderControl::show(ui, "Vignette Amount", &mut s.active_lens_vignette_amount, -100.0..=100.0, 1.0);
                SliderControl::show(ui, "Vignette Midpoint", &mut s.active_lens_vignette_midpoint, 0.0..=100.0, 1.0);
            });
        });
    });
...
fn test_hsl_hue_section_exists() {
    ...
    let section = harness.get_by_label("HSL / Hue");
...
fn test_hsl_hue_red_control_exists() {
    ...
    let control = harness.get_by_label("Red Hue");
...
fn test_hsl_hue_orange_control_exists() {
    ...
    let control = harness.get_by_label("Orange Hue");
...
fn test_hsl_hue_yellow_control_exists() {
    ...
    let control = harness.get_by_label("Yellow Hue");
...
fn test_hsl_hue_green_control_exists() {
    ...
    let control = harness.get_by_label("Green Hue");
...
fn test_hsl_hue_aqua_control_exists() {
    ...
    let control = harness.get_by_label("Aqua Hue");
...
fn test_hsl_hue_blue_control_exists() {
    ...
    let control = harness.get_by_label("Blue Hue");
...
fn test_hsl_hue_purple_control_exists() {
    ...
    let control = harness.get_by_label("Purple Hue");
...
fn test_hsl_hue_magenta_control_exists() {
    ...
    let control = harness.get_by_label("Magenta Hue");
...
fn test_hsl_luminance_section_exists() {
    ...
    let section = harness.get_by_label("HSL / Luminance");
...
fn test_hsl_lum_red_control_exists() {
    ...
    let control = harness.get_by_label("Red Lum");
...
fn test_hsl_lum_orange_control_exists() {
    ...
    let control = harness.get_by_label("Orange Lum");
...
fn test_hsl_lum_yellow_control_exists() {
    ...
    let control = harness.get_by_label("Yellow Lum");
...
fn test_hsl_lum_green_control_exists() {
    ...
    let control = harness.get_by_label("Green Lum");
...
fn test_hsl_lum_aqua_control_exists() {
    ...
    let control = harness.get_by_label("Aqua Lum");
...
fn test_hsl_lum_blue_control_exists() {
    ...
    let control = harness.get_by_label("Blue Lum");
...
fn test_hsl_lum_purple_control_exists() {
    ...
    let control = harness.get_by_label("Purple Lum");
...
fn test_hsl_lum_magenta_control_exists() {
    ...
    let control = harness.get_by_label("Magenta Lum");
...
fn test_lens_corrections_section_exists() {
    ...
    let section = harness.get_by_label("Lens Corrections");
...
fn test_lens_distortion_control_exists() {
    ...
    let control = harness.get_by_label("Distortion");
...
fn test_lens_vignette_amount_control_exists() {
    ...
    let control = harness.get_by_label("Vignette Amount");
...
fn test_lens_vignette_midpoint_control_exists() {
    ...
    let control = harness.get_by_label("Vignette Midpoint");
...
fn test_all_advanced_controls_exist() {
    ...
    for control_name in hsl_hue_controls {
        let control = harness.get_by_label(control_name);
...
#[test]
fn test_hsl_hue_controls_bound_to_state() {
    let (mut harness, state) = create_develop_view_harness();
    harness.run();
    
    // Verify initial state values are 0.0
    {
        let s = state.borrow();
        assert_eq!(s.active_hsl_red_hue, 0.0);
        assert_eq!(s.active_hsl_orange_hue, 0.0);
        assert_eq!(s.active_hsl_yellow_hue, 0.0);
        assert_eq!(s.active_hsl_green_hue, 0.0);
        assert_eq!(s.active_hsl_aqua_hue, 0.0);
        assert_eq!(s.active_hsl_blue_hue, 0.0);
        assert_eq!(s.active_hsl_purple_hue, 0.0);
        assert_eq!(s.active_hsl_magenta_hue, 0.0);
    }
}

#[test]
fn test_hsl_lum_controls_bound_to_state() {
    let (mut harness, state) = create_develop_view_harness();
    harness.run();
    ...
    {
        let s = state.borrow();
        assert_eq!(s.active_hsl_red_lum, 0.0);
        assert_eq!(s.active_hsl_orange_lum, 0.0);
        assert_eq!(s.active_hsl_yellow_lum, 0.0);
        assert_eq!(s.active_hsl_green_lum, 0.0);
        assert_eq!(s.active_hsl_aqua_lum, 0.0);
        assert_eq!(s.active_hsl_blue_lum, 0.0);
        assert_eq!(s.active_hsl_purple_lum, 0.0);
        assert_eq!(s.active_hsl_magenta_lum, 0.0);
    }
}

#[test]
fn test_lens_controls_bound_to_state() {
    let (mut harness, state) = create_develop_view_harness();
    harness.run();
    ...
    {
        let s = state.borrow();
        assert_eq!(s.active_lens_distortion, 0.0);
        assert_eq!(s.active_lens_vignette_amount, 0.0);
        assert_eq!(s.active_lens_vignette_midpoint, 0.0);
    }
}
